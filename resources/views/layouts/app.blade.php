...
<head>
    ...
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
 	    ...
 	    <script src="http://localhost/skydentalclinics/public/ckeditor_full/ckeditor.js "></script>
	    ...
	    <script src="http://localhost/skydentalclinics/public/datatable/js/jquery.dataTables.min"></script>
	    <script src="http://localhost/skydentalclinics/public/datatable/js/dataTables.bootstrap.min"></script>
	    <script src="http://localhost/skydentalclinics/public/datatable/js/dataTables.responsive.min"></script>
	    <script src="http://localhost/skydentalclinics/public/datatable/js/responsive.bootstrap.min"></script>
